...
## Add County Data
```{r}
https://www.countyhealthrankings.org/sites/default/files/media/document/state/downloads/2011%20County%20Health%20Ranking%20New%20York%20Data%20-%20v4.xls 

https://www.countyhealthrankings.org/sites/default/files/media/document/state/downloads/2012%20County%20Health%20Ranking%20New%20York%20Data%20-%20v4.xls

https://www.countyhealthrankings.org/sites/default/files/media/document/2022%20County%20Health%20Rankings%20New%20York%20Data%20-%20v2.xlsx

https://www.countyhealthrankings.org/sites/default/files/media/document/state/downloads/2014%20County%20Health%20Rankings%20New%20York%20Data%20-%20v6.xls

download_county_data <- function(url, destfile){
...
urls <- paste0("https://www.countyhealthrankings.org/sites/default/files/media/document/state/downloads/",
               years,
               "%20County%20Health%20Ranking%20New%20York%20Data%20-%20v4.xls")

output <- paste0("C:/Users/Mitchell/Documents/Thesis GU/Data", years, ".xls")

walk2(.x = urls, .y = output, .f =download_county_data)
```
...
initial_reg <- lm(difference_in_discharges ~ hospital_ownership_type,data = SPARCS_combined)
...
```{r}
linear_control <- lm(difference_in_discharges ~ hospital_ownership_type + bed_size + net_patient_revenue + net_charity_care_cost + year + hospital_name.y,data = SPARCS_combined)
