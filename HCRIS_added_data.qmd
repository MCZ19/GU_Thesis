...
combined_2011 <- left_join(year_2011,
                           year_2011_v2,
                           by = "County")
...
combined_2012 <- left_join(year_2012,
                           year_2012_v2,
                           by = "County")
...
combined_2013 <- left_join(year_2013,
                           year_2013_v2,
                           by = "County")
...
# Final
total_combined <- left_join(combined_2011,
                            combined_2012,
                            by = c("County",
                              "year"))

total_combined %>% select(contains("year"))
```
