...
table_hospital_effects <- hospital_fixed_effects %>% stargazer(type = "text", title = "Hospital Fixed Effects Regression", report = "vcs*p", single.row = TRUE, ci = TRUE, ci.level = 0.95, mean.sd = TRUE, p.auto = TRUE, digits = 3, se_type = "HC1")
...
table_time_effects <- time_fixed_effects %>% stargazer(type = "text", title = "Year Fixed Effects Regression", report = "vcs*p", single.row = TRUE, ci = TRUE, ci.level = 0.95, mean.sd = TRUE, p.auto = TRUE, digits = 3, se_type = "HC1")
```
...
initial_reg %>%
          ...
          fixed_effects %>%
          Controls_added %>%
          stargazer(type = "text", title = "", report = "vcs*p", single.row = TRUE, ci = TRUE, ci.level = 0.95, mean.sd = TRUE, p.auto = TRUE, digits = 3, se_type = "HC1")
