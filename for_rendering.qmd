...
test3 <- lm(difference_in_discharges_imputed ~ hospital_ownership_type + bed_size_imputed + net_patient_revenue_hundred_thousand_imputed + net_charity_care_cost_ten_thousand_imputed + medicare_payer_mix_imputed + medicaid_payer_mix_numeric_imputed + inpatient_occupancy_imputed + direct_patient_care_labor_hours_numeric_imputed + percent_children_in_poverty_imputed +
              percent_unemployed_imputed +
              percent_smokers_imputed +
              percent_excessive_drinking_imputed +
              percent_obese_imputed +
...
test5 <- plm(difference_in_discharges_imputed ~ hospital_ownership_type + year + hospital_name.y + bed_size_imputed + net_patient_revenue_hundred_thousand_imputed + net_charity_care_cost_ten_thousand_imputed + medicare_payer_mix_imputed + medicaid_payer_mix_numeric_imputed + inpatient_occupancy_imputed +
              direct_patient_care_labor_hours_numeric_imputed+
              percent_unemployed_imputed +
              percent_smokers_imputed +
              percent_excessive_drinking_imputed +
