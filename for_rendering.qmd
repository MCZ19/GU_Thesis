...
hospital_fixed_effects_plm <- plm(difference_in_discharges ~ hospital_ownership_type + bed_size + net_patient_revenue_hundred_thousand + net_charity_care_cost_ten_thousand,
    data = numeric_data,
