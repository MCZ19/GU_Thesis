...
table_initial_reg <- initial_reg %>% stargazer(type = "text", title = "Linear Regression Results", single.row = TRUE, ci = TRUE, ci.level = 0.95, mean.sd = TRUE, p.auto = TRUE, digits = 3)
...
table_control_linear_reg <- linear_control %>%
  stargazer(type = "text", title = "Linear Regression Results", single.row = TRUE, ci = TRUE, ci.level = 0.95, mean.sd = TRUE, p.auto = TRUE, digits = 3)
```
