...
net_charity_care_cost_hundred_thousand ~ "Net Charity Care Costs in Hundreds of Thousands of Dollars",
...
`Non-Profit` ~ "Dummy Variable between Non-Profit and Government Hospitals")) %>%
  ...
  as_gt() %>%
  gt::gtsave("Descriptive_Stats01.png")
...
Complete_imputed_table <- stargazer(test,
          ...
          title = "KNN Imputed Regression Models", 
                                               ...
                                               single.row = TRUE,
                                               digits = 3,
                                               covariate.labels = c("Non-Profit Hospitals vs. Government Hospitals", "Number of Beds",
          ...
          add.lines = list(c('Fixed Effects', 'No',
                             'No', 'No', 'Yes', 'Yes')),
          out = "KNN_Imputed_Regressions_March.htm")
```
